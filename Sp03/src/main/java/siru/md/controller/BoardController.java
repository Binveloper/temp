...
public class BoardController {
	...
	public ModelAndView list(String cp, String ps, HttpSession session) {
        ...
        return new ModelAndView("board/List", "listResult", listResult);
    }
	...
	public ModelAndView insert(Board board) {
		...
		return new ModelAndView("board/Write", "flag", flag);
	}
	...
	public ModelAndView Update(Board board) {
		...
		return new ModelAndView("board/Update2", "flag", flag);
	}
}
